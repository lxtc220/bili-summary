...
def main():
    ...
    try:
        url = "https://www.bilibili.com/video/BV1p743zREkN/?spm_id_from=333.1007.top_right_bar_window_default_collection.content.click&vd_source=6cec98d87e21778c3c0afc1d666bf38b"
        print(f"处理的URL: {url}")
